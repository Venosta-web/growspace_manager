...
def _serialize(value: Any) -> str:
    ...
    if isinstance(value, Sequence) and not isinstance(value, (bytes, bytearray)):
        # `bytes` is a Sequence, and would otherwise canonicalize as an array
        # of its integers -- bytes that look canonical for a value JSON does
        # not have, which is the one thing this module exists to prevent.
